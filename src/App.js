...
class App extends Component {
  ...
  logout = () => {
	...
	onUpdate(index){
		window.updateid= this.state.posts[index]._id;
		window.updateauthor= this.state.posts[index].author;
		window.updatedescription= this.state.posts[index].description;
	}
    onAddComment(index){
		window.commentid = this.state.posts[index]._id
		window.commentarray = this.state.posts[index].comment
	}
    onShowComment(index){
		window.commentarray = this.state.posts[index].comment
	}
